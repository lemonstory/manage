...
class cron_analyticsDownNum extends DaemonBase {
	...
	protected function deal() {
		...
		$personnum = $list['pn'];
		$downnum = $list['tn'];
	    $flag = $analytics->putanalyticsdown($timeline, $personnum, $downnum);
		echo "$day down update flag:$flag\n";
	}

	protected function checkLogPath() {}

}
new cron_analyticsDownNum ();