    ...
    protected function c_lrts_category()
    {
        ...
        foreach ($category_list as $k => $v) {
            ...
            if ($category_id) {
                ...
                $content = "{$category_id} 入库 \r\n";
                $manageCollectionCronLog->writeLog(ManageCollectionCronLog::ACTION_SPIDER_SUCESS, ManageCollectionCronLog::TYPE_LRTS_CATEGORY,$content);
            } else {
        ...
        $content = sprintf("分类总数量:%d, 已忽略 %d, 新增 %d \r\n", $category_count, $ignore_count, $add_count);
        echo $content;
